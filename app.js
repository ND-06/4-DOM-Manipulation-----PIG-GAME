...
// btn(); // if we want to call this function, by default we write it like this

// function declared outside the event but used in event ( in 2d argument, always without parenthesis)
